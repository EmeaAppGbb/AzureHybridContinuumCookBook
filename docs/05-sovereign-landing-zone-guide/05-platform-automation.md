...
graph LR
    ...
    style Source fill:#edf5d6,stroke:#107c10,stroke-width:2px
    style CI fill:#d4f1fb,stroke:#0078d4,stroke-width:2px
    style Artifacts fill:#fff3cd,stroke:#d83b01,stroke-width:2px
    style CD fill:#e0f7fa,stroke:#0078d4,stroke-width:2px
    style Disconnected fill:#f0f0f0,stroke:#ffb900,stroke-width:3px
    style Monitoring fill:#ede7f6,stroke:#5e5e5e,stroke-width:2px
