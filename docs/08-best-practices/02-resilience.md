...
graph TB
    ...
    style Global fill:#dceefb,stroke:#005a9e,stroke-width:3px
    style Region1 fill:#e0f7fa,stroke:#0078d4,stroke-width:2px
    style Region2 fill:#e0f7fa,stroke:#0078d4,stroke-width:2px
    ...
    style OnPrem fill:#dff0df,stroke:#004b1c,stroke-width:3px
    style Site fill:#e0f7fa,stroke:#0078d4,stroke-width:2px
