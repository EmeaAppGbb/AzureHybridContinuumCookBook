...
graph TB
    ...
    style Layer1 fill:#fce4e6,stroke:#dc3545,stroke-width:2px
    style Layer2 fill:#fff0e0,stroke:#fd7e14,stroke-width:2px
    style Layer3 fill:#fff8e1,stroke:#f57c00,stroke-width:2px
    style Layer4 fill:#e0f5f0,stroke:#20c997,stroke-width:2px
    style Layer5 fill:#dceefb,stroke:#0078d4,stroke-width:2px
    style Layer6 fill:#ede7f6,stroke:#6f42c1,stroke-width:2px
    style Attacker fill:#2d2d2d,stroke:#dc3545,stroke-width:3px,color:#fff
