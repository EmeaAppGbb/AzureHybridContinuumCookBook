...
graph TB
    ...
    style Before fill:#e0f7fa,stroke:#0078d4,stroke-width:3px
    style After fill:#dff0df,stroke:#004b1c,stroke-width:3px
    style CloudDeps fill:#fce4e6,stroke:#a71d2a,stroke-width:2px
    style LocalServices fill:#dff0df,stroke:#004b1c,stroke-width:2px
```
